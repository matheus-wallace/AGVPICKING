...
- [ ] 4.4 Quando `add-state-driven-voice-flow` estiver concluído, repetir uma ordem de múltiplas linhas sem tocar em avanço na tela operacional. **Bloqueada por `add-state-driven-voice-flow`: sem o avanço por voz, o percurso completo ainda depende dos botões do painel de desenvolvimento.**
